...
const chipTools = [
    ...
    { id: 'rtl-simulation', name: 'RTL Simulation', description: 'Verify the functional correctness of your RTL design using simulated inputs and outputs.', icon: <FaChartLine className="text-green-500 text-4xl mb-4" />, path: '/tool/rtl-simulation', requiredPlan: 'standard' },
    { id: 'static-timing', name: 'Static Timing Analysis (STA)', description: 'Analyze critical path delays and ensure your design meets timing constraints.', icon: <FaClock className="text-yellow-500 text-4xl mb-4" />, path: '/tool/static-timing', requiredPlan: 'free' },
