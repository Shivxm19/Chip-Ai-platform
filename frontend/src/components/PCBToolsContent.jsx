...
const pcbTools = [
    { id: 'schematic-editor', name: 'Schematic Editor', description: 'Design and capture your circuit schematics with intelligent component management.', icon: <FaVectorSquare className="text-red-400 text-4xl mb-4" />, path: '/tools/pcb/schematic-editor', requiredPlan: 'free' },
    ...
    { id: 'routing-assistant', name: 'Smart Routing Assistant', description: 'Accelerated trace routing with AI guidance.', icon: <FaNetworkWired className="text-indigo-400 text-4xl mb-4" />, path: '/tool/routing-assistant', requiredPlan: 'standard' },
